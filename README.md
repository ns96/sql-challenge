...
## Description
The goal of this project was created an ERD diagram, created a database with appropriate tabels, then import data from the six provided CSV documents. Once imported, several queries were executed to answer key questions about employee departments, salaries, managers and other points of interests. 

## Entity Relationship Diagram
![ERD](EmployeeSQL/quickERD.png "ERD Diagram")
